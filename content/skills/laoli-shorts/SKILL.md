...
> - **❌ 不通过** → 读取 `文案/评审记录.md` 中的修改意见，修复后重新提交评审（设 ⏳ 待评审）
...
**产出确认**：在`文案/评审记录.md`中写入提交说明（详见 `references/review-guide.md` 中的「提交说明格式」），设状态为 ⏳ 待评审，等待 Owner 安排审核。
...
展示 `素材/定妆/` 下所有已生成图片，按以下清单自检：
  ...
  - **自检通过后**：在`文案/评审记录.md`中写入提交说明（详见 `references/review-guide.md` 中的「提交说明格式」），设状态为 ⏳ 待评审，等待 Owner 安排审核
