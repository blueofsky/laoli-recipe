...
```bash
/laoli-comic content.md --storyboard-only
```
...
```bash
/laoli-comic content.md --prompts-only
```
...
```bash
/laoli-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/laoli-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/laoli-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/laoli-comic comic/topic-slug/ --regenerate 0
```
