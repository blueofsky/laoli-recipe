...
**agnes 视频 API 忽略 `--size` 参数**，实际输出固定 704px 宽，高度随比例变化：

| 请求 size | 实际输出 | 实际比例 |
|-----------|---------|---------|
| 648×1152 (9:16) | **704×1152** | 11:18 |
| 648×1152 (文生) | **704×1280** | 11:20 |

agnes **图片** API 正常，`--size` 精确生效。仅视频有此问题。

放入剪映 1080×1920 画布会有黑边。如需标准 1080×1920，用 **tuzi** provider。
